...
const juanita = new Student('Juanita', 25, ['Curso 1', 'Curso 2', 'Curso 3']);
...
class Student2 {
  ...
  constructor({
    ...
    this.name = name;
    this.age = age;
    (this.approvedCourses = approvedCourses), (this.email = email);
...
const miguel = new Student2({
  ...
  approvedCourses: ['Curso 1', 'Curso 2', 'Curso 3', 'Curso 4'],
});
  ...
  learningPaths: [
    {
      ...
      courses: ['Curso DW 1', 'Curso DW 2', 'Curso DW 3', 'Curso DW 4'],
    },
    {
      name: 'Escuela de JavaScript',
      courses: ['Curso JS 1', 'Curso JS 2', 'Curso JS 3', 'Curso JS 4'],
    },
  ],
};
